...
public class Main {
    public static void main(String[] args) {
        ...
        TreeSet<Point> pointTreeSet = new TreeSet<>(new Comparator<Point>() {
            @Override
        ...
        System.out.println(
                "After sort index of point is " + pointArrayList.indexOf(point1)); // After sort index of point is 9
        System.out.println("ArrayList:");
        for (Point point : pointArrayList) {
            System.out.println(point);
        }

        System.out.println("TreeSet contains point [1,2] "
                + pointTreeSet.contains(new Point(1, 2))); // TreeSet contains point [1,2] true
        System.out.println("TreeSet contains point [3,5] "
                + pointTreeSet.contains(new Point(3, 5))); // TreeSet contains point [3,5] false
